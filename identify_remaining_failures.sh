...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Identifying Remaining Test Failures${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
echo -e "${YELLOW}Running integration tests to identify failures...${NC}"
echo ""

# Run integration tests and capture failures
OUTPUT_FILE="/tmp/test_failures_$$.txt"
...
if [ -n "$FAILED_TESTS" ]; then
    ...
    echo ""
    echo -e "${YELLOW}To run a specific test with full traceback:${NC}"
...
echo ""
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Error Tests Summary${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
