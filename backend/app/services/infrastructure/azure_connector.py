...
from app.services.infrastructure.azure_connector_cleanup_mixin import AzureConnectorCleanupMixin

logger = get_logger(__name__)


class AzureBastionConnector(AzureConnectorCleanupMixin, InfrastructureConnector):
    ...
    # Azure VM cleanup - now provided by AzureConnectorCleanupMixin
