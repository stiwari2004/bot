# Quick Migration Commands - DEV Environment

## Your Current Setup
- **Container**: `bot-dev-postgres`
- **Database**: `troubleshooting_ai_dev`
- **Issue**: SQL file not found on server

---

## Solution 1: Run Migration Directly (No File Needed)
...
## Solution 2: Copy File to Server First

**If you want to copy the file from your local machine to server:**

```bash
# On your local machine (Windows), use SCP or similar:
scp backend/sql/create_scheduled_reports_table.sql opsadmin@srv640992:/opt/opsbot/bot/backend/sql/
...
docker exec -i bot-dev-postgres psql -U postgres -d troubleshooting_ai_dev -c "SELECT COUNT(*) FROM scheduled_reports;"
```
